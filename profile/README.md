...
Axiora is an open-core IDE powered entirely by local AI models.
...
We're in early alpha. The best time to shape Axiora is now.

- ⭐ Star [`axiora-dev/axiora`](https://github.com/axiora-dev/axiora) to follow progress
- 🐛 Open issues — bugs, ideas, feature requests
- 🔧 Check [`good first issue`](https://github.com/axiora-dev/axiora/issues?q=label%3A%22good+first+issue%22) to contribute
- 💬 Join the conversation on [Discord](https://discord.gg/axiora)
...
<div align="center">
  <sub>Built in public · Open core · MIT licensed</sub>
</div>
